                    ...
                    <?php if(count($kqtk) > 0) :?>
                        <?php foreach($kqtk as $item) :?>
                            <div class="col-md-3 item-product bor">
                                ...
                                <div class="hidenitem">
                                    <ul>
                                        <li><a href="chi-tiet-san-pham.php?id=<?php echo $item['id'] ?>--<?php echo $item['slug'] ?>" title="Chi tiết sản phẩm "><i class="fa fa-search"></i></a></li>
                                        <li><a href="" title="Thêm vào sản phẩm yêu thích "><i class="fa fa-heart"></i></a></li>
                                        <li><a href="them-gio-hang.php?id=<?php echo $item['id'] ?>" title="Thêm vào giỏ hàng "><i class="fa fa-shopping-basket"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        <?php endforeach ; ?>
