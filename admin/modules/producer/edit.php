<?php
    ...
    */
    ...
    $tintuc = $db->fetchID("nhacungcap", $id) ;
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        if( empty($error))
        {
            ...
            $id_update = $db->update("nhacungcap" , $data , array('id' => $id));   
                        ...
                        <div class="form-body ">
                            ...
                            <div class="col-md-12 bor" style="padding-top: 20px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" name="tennhacc" class="form-control col-md-7 col-xs-12" value="<?php echo isset($tintuc) ? $tintuc['tennhacc'] : '' ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" name="diachi" class="form-control col-md-7 col-xs-12" value="<?php echo isset($tintuc) ? $tintuc['diachi'] : '' ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" name="sodienthoai" class="form-control col-md-7 col-xs-12" value="<?php echo isset($tintuc) ? $tintuc['sodienthoai'] : '' ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" name="email" class="form-control col-md-7 col-xs-12" value="<?php echo isset($tintuc) ? $tintuc['email'] : '' ?>">
                                    </div>
                                </div>
