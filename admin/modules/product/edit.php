                    ...
                    <form role="form" method="POST" class="form-horizontal ng-pristine ng-valid" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-body ">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="first-name"> Giá bán <span class="required">(*)</span> </label>
                                    <div class="col-md-8">
                            ...
                            <div class="col-md-9 bor">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                         ...
                                         <textarea name="mota" id="content" class="form-control" rows="10"><?php echo (isset($productEdit['mota']) ? $productEdit['mota'] : '') ?></textarea>
