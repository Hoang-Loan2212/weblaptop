<?php
    ...
    */
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        {
            $error['giamgia'] = '  Giảm giá phải lớn hơn 0 và nhỏ hơn 100';
        }
        ...
        if ($soluong == '')
        {
            $error['soluong'] = "Số lượng sản phẩm không được để trống !";
        }
                        ...
                        <div class="form-body ">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="number" id="first-name" name="giamgia" min="0" max="100" class="form-control" value="<?php echo isset($gia) ? $gia : '0' ?>">
                                    </div>
                                </div>
                            ...
                            <div class="col-md-9 bor">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <textarea name="mota" id="content" class="form-control" rows="10"><?php echo (isset($tintuc['mota']) ? $tintuc['mota'] : '') ?></textarea>
