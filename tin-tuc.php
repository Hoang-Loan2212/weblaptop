                        ...
                        <div class="col-md-12">
                            <a href="tin-tuc-chi-tiet.php?id=<?php echo $item['id'] ?>-<?php echo $item['slug'] ?>">
                                ...
                                <div class="info pull-right  post">
                                    ...
                                    <p style="padding-top: 10px;padding-bottom: 10px;"><?php echo $item['noidung'] ?></p>
                                    <span class="view"><i class="fa fa-clock-o"></i> <strong><?php echo $item['created_at'] ?></strong></span>
                                </div>
                            </a>
                        </div>
                    <?php endforeach ; ?>
